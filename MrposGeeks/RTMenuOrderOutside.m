...
@interface RTMenuOrderOutside ()<RTMenuOrderSingleDishDelegate,RTMenuOrderPackageDelegate>
{
...
@implementation RTMenuOrderOutside
...
-(void)getNewOrderSid{
    NSString *sqlstr = @"";
    sqlstr = [NSString stringWithFormat:@"insert into orderdata(`desktop`,`orderdata`,`is_outside`,`is_upload`,`server_id`,`create_date`) values('', '', 1, 0, 0 ,'%@')",
...
- (void)addPackage{
    ...
    mainview.isInSide = NO;
    mainview.isOutSide = YES;
